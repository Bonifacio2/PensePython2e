...
A primeira linha da definição de função chama-se cabeçalho; o resto é chamado de corpo. O cabeçalho precisa terminar em dois pontos e o corpo precisa ser indentado. Por convenção, a indentação sempre é de quatro espaços. O corpo pode conter qualquer número de instruções.
